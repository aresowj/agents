...
| **Complex Implementation** | `devstral small 2 24b instruct`, `gpt-oss 20b` | Medium/Large | Unload Orchestrator. Load one at a time for high-complexity tasks. |
| **Standard Coding** | `gemma-4-26b-a4b-it-ud@q5_k_m`, `qwen2.5 coder 32b instruct`, `omnicoder 9b` | Medium | Unload Orchestrator. Can be loaded alongside very small models. |
| **Fast/Simple Tasks** | `qwen2.5 coder 1.5b instruct` | Small | Load multiple in parallel for high-throughput, low-reasoning work. |
